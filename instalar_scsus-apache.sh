...
sudo apt install php8.1-{snmp,memcached,bcmath,fpm,xml,mysql,zip,intl,ldap,gd,cli,bz2,curl,mbstring,pgsql,opcache,soap,cgi} -y

sudo apt install php8.1-pdo_pgsql php8.1-pdo_mysql -y
